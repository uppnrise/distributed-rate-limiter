...
wget https://github.com/uppnrise/distributed-rate-limiter/releases/download/v1.4.2/distributed-rate-limiter-1.4.2.jar.sha256
sha256sum -c distributed-rate-limiter-1.4.2.jar.sha256
```
...
curl -O https://raw.githubusercontent.com/uppnrise/distributed-rate-limiter/v1.4.2/docker-compose.yml
docker compose up -d
```
